...
urlpatterns = [
    ...
    path('categories/<int:pk>/', category_detail, name='category_detail'), # Add in paths for user interface
    ...
    path('orders/arrange/', create_order, name="create_order"), # Add in paths for user interface
]
